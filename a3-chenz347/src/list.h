...
// NOTE: This linked list implementation is different from what you might be
// used
 ...
 */
static inline void
list_entry_init(list_entry* entry)
{
  entry->next = NULL;
  entry->prev = NULL;
}
...
static inline bool
list_entry_is_linked(list_entry* entry)
{
...
static inline void
__list_insert(list_entry* entry, list_entry* prev, list_entry* next)
{
  next->prev = entry;
  entry->next = next;
  entry->prev = prev;
 ...
 */
static inline void
list_add_head(list_head* list, list_entry* entry)
{
 ...
 */
static inline void
list_add_tail(list_head* list, list_entry* entry)
{
